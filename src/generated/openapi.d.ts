export interface paths {
    ...
    "/v1/media": {
         ...
         *     actual content type and limits, hashes bytes, and streams them to private disk.
         *     One bounded whole-file buffer is used afterward for content validation. Media
         *     is scope-bound and removed no later than 12 hours after staging or when its
         *     linked operation completes or expires, whichever is earlier.
         */
    ...
    "/v1/operations": {
         ...
         * @description Creates a typed pending operation; it does not execute it. The service validates
         *     supported local semantics, scoped assets, media, and mutation targets before
         *     persistent creation. expires_at is exactly created_at + 12 hours.
...
export interface components {
    schemas: {
        ...
        Problem422Operation: components["schemas"]["ProblemBase"] & {
            ...
            status?: 422;
            /** @enum {string} */
            code?: "unsupported_campaign_variant" | "unsupported_campaign_combination" | "asset_incompatible" | "operation_semantics_invalid";
        };
    ...
    responses: {
        ...
        /** @description Operation payload, campaign combination, mutation target, or bound assets are semantically invalid. */
